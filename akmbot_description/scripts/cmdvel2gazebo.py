...
class CmdVel2Gazebo:
    ...
    def __init__(self):
        ...
        self.pub_steerL = rospy.Publisher('/akmbot/front_left_steering_position_controller/command', Float64, queue_size=1)
        self.pub_steerR = rospy.Publisher('/akmbot/front_right_steering_position_controller/command', Float64, queue_size=1)
        self.pub_rearL = rospy.Publisher('/akmbot/rear_left_velocity_controller/command', Float64, queue_size=1)
        self.pub_rearR = rospy.Publisher('/akmbot/rear_right_velocity_controller/command', Float64, queue_size=1)
